        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-3">
                        ...
                        <img src="../users/covers/<?php echo $row['cover'] ?>" width="150px" class="img-thumbnail">
                        <br><br>
                        <form role="form" action="../upload_user_photo" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-5">
                    ...
                    <span class="glyphicon glyphicon-lock"></span> Your password was updated at : <?php echo $row['updated_at'] ?>
                     <br><br><br>
                    <input type="hidden" name="id" id="id" value="<?php echo $row['id'] ?>">
                    <button class="btn btn-danger" id="delete_user_account"><span class="glyphicon glyphicon-remove-circle" ></span> Delete this account</button>
                    <br><br><br>
                        ...
                        <div id="edit_pass" >
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <button class="btn btn-primary btn-block" id="update_user_pass"><span class="glyphicon glyphicon-upload"></span> Updated Now</button>
                                            </div>
                                        </div>
